        ...
        <details class="researcher-work-record">
          <summary class="researcher-work-heading">
            <span class="researcher-work-label">
              <span>현재 연구 기록</span>
              <span lang="en">Current Research Record</span>
            </span>
          ...
          <div class="researcher-work-body">
            ...
            <section class="embedded-trajectory" aria-labelledby="yoon-trajectory-title">
              <header>
                <div>
                  <span class="section-index">Research Path</span>
                  <h3 id="yoon-trajectory-title">연구의 발전 경로</h3>
                </div>
                <p>경쟁과 서열의 비판에서 공정성 탐구를 거쳐 두 관점의 종합으로 이어집니다.</p>
              </header>
              <ol class="embedded-trajectory-list">
                <li>
              ...
              <div class="embedded-trajectory-branch">
                <span>별도 갈래</span>
                <a href="https://doi.org/10.5281/zenodo.22718001">팬데믹의 사회적 문제: 혐오·낙인과 교육 격차 ↗</a>
              </div>
              <a class="embedded-trajectory-link" href="{{ '/constellation/' | relative_url }}">
                <span>질문의 별자리에서 전체 관계 보기</span>
